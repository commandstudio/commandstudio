function Commander() {
  ...
  var projectSave = localStorage.getItem( 'commander-project' );
  if( projectSave !== null ) {
...
Commander.prototype = {
  ...
  initEvents : function() {
    ...
    ui.events.on( 'toolbar.commander-manual', function() {
    ...
    ui.events.on( 'files.change', function() {
      ...
      saveCooldown = window.setTimeout( function() {
        ...
        localStorage.setItem( 'commander-project', JSON.stringify(files) );
        saveCooldown = null;
      }, 1000);
    });
